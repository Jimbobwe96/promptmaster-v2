...
import { GameState, Lobby, GameRound, Player, Lobby2 } from '@promptmaster/shared';
...
export class GameService {
  ...
  // new method for fetching lobby data - first entry point for most methods
  ...
  // sample implementation with new schema. lobbies have gamestate, which has rounds.
  //
