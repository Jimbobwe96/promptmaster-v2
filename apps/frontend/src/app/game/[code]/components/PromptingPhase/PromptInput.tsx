...
export const PromptInput = forwardRef<PromptInputHandle, PromptInputProps>(({ endTime, onSubmit }, ref) => {
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-sm">
      <div className="mb-6">
        <h2 className="text-xl font-semibold text-slate-800 mb-2">Enter Your Prompt</h2>
        <p className="text-slate-600">Describe the image you want to generate. Be creative!</p>
      </div>
